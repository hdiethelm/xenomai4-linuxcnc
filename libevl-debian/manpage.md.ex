...
libevl - program to do something

# SYNOPSIS

**libevl** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**libevl** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **libevl** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**libevl** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    libevl. See **foo.conf**(5) for further details.
...
**libevl** provides some return codes, that can be used in scripts:
...
Copyright © 2007 Hannes Diethelm
